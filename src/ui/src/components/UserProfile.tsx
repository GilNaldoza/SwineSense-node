...
export function UserProfile({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl border border-slate-200 w-full max-w-lg overflow-hidden relative animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {autoResetDuration && (
        <div
          className="absolute top-0 left-0 right-0 h-1.5 bg-linear-to-r from-green-500 via-emerald-400 to-green-500 z-20 animate-shrink"
          style={{
            width: "100%",
      ...
      <div className="bg-linear-to-br from-blue-500 via-blue-600 to-indigo-600 p-6 text-white relative overflow-hidden">
        <div
      ...
      <div className="p-6 space-y-5">
        ...
        <div className="space-y-3">
          {data.college && (
            <div className="flex items-start gap-3 p-4 bg-linear-to-br from-slate-50 to-blue-50/30 rounded-xl border border-slate-100">
      ...
      <div className="p-6 pt-0">
        <button
          onClick={onEdit}
          className="w-full bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold py-3.5 px-6 rounded-xl flex items-center justify-center gap-2 transition-all shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-[0.98]"
        >
          <Edit2 size={18} />
          Edit Profile
        </button>
